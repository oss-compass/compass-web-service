          ...
          "children": [
            {
              ...
              "children": [
                {
                  "name": "Community Ecosystem Health / 社区生态健康评估",
                  "description": "Operations about Community Ecosystem Health",
                  "children": [
                    {
                      "name": "Collaboration Efficiency / 协作效率",
                      "description": "Operations about Collaboration Efficiency",
                      "children": [
                        { "name": "Response Timeliness / 响应及时性", "description": "Operations about Response Timeliness" },
                        { "name": "Collaboration Quality / 协作开发质量", "description": "Operations about Collaboration Quality" }
                      ]
                    },
                    {
                      "name": "Community Vitality / 社区活力",
                      "description": "Operations about Community Vitality",
                      "children": [
                        { "name": "Community Popularity / 社区流行度", "description": "Operations about Community Popularity" },
                        { "name": "Contribution Activity / 贡献活跃度", "description": "Operations about Contribution Activity" },
                        { "name": "Developer Base / 开发者基数", "description": "Operations about Developer Base" }
                      ]
                    },
                    {
                      "name": "Development Governance / 开放治理",
                      "description": "Operations about Development Governance",
                      "children": [
                        { "name": "Organizational Governance / 组织开放治理", "description": "Operations about Organizational Governance" },
                        { "name": "Personal Governance / 个人开放治理", "description": "Operations about Personal Governance" }
                      ]
                    }
                  ]
                },
                {
                  "name": "Developer Journey / 开发者旅程评估",
                  "description": "Operations about Developer Journey",
                  "children": [
                    {
                      "name": "Developer Attraction / 开发者吸引",
                      "description": "Operations about Developer Attraction",
                      "children": []
                    },
                    {
                      "name": "Developer Growth / 开发者成长",
                      "description": "Operations about Developer Growth",
                      "children": [
                        { "name": "Participation Tier / 开发者参与度分层", "description": "Operations about Participation Tier" },
                        { "name": "Developer Promotion / 开发者晋升", "description": "Operations about Developer Promotion" }
                      ]
                    },
                    {
                      "name": "Developer Retention / 开发者留存",
                      "description": "Operations about Developer Retention",
                      "children": [
                        { "name": "Core Retention / 核心开发者留存率", "description": "Operations about Core Retention" },
                        { "name": "Core Churn / 核心开发者淡出率", "description": "Operations about Core Churn" },
                        { "name": "Core Loss / 核心开发者流失率", "description": "Operations about Core Loss" }
                      ]
                    }
                  ]
                },
                {
                  "name": "Opensource Software Supply Chain Security / 开源软件供应链安全评估",
                  "description": "Operations about Opensource Software Supply Chain Security",
                  "children": [
                    {
                      "name": "Source Management / 源码管理",
                      "description": "Operations about Source Management",
                      "children": [
                        { "name": "Legal Compliance / 合法合规", "description": "Operations about Legal Compliance" },
                        { "name": "Security Management / 安全管理", "description": "Operations about Security Management" }
                      ]
                    },
                    {
                      "name": "Release and Maintenance / 发布与维护",
                      "description": "Operations about Release and Maintenance",
                      "children": [
                        { "name": "Release Quality / 发布质量", "description": "Operations about Release Quality" },
                        { "name": "Maintenance Management / 维护管理", "description": "Operations about Maintenance Management" }
                      ]
                    },
                    {
                      "name": "Dev and Build / 开发与构建",
                      "description": "Operations about Dev and Build",
                      "children": [
                        { "name": "Code Review Quality / 代码审查质量", "description": "Operations about Code Review Quality" },
                        { "name": "Development Document Quality / 开发文档质量", "description": "Operations about Development Document Quality" },
                        { "name": "Trusted Build / 可信构建", "description": "Operations about Trusted Build" }
                      ]
                    }
                  ]
                }
