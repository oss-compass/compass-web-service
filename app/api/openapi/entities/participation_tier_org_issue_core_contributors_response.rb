...
module Openapi
  module Entities
    class ParticipationTierOrgIssueCoreContributorsItem < Grape::Entity
      expose :uuid, documentation: { type: 'String', desc: 'uuid' }
      expose :level, documentation: { type: 'String', desc: 'level', example: 'repo' }
      expose :label, documentation: { type: 'String', desc: 'label' }
      expose :org_issue_core_contributors,
             documentation: {
               type: 'Integer',
               desc: 'Org Issue core contributors (incl. managers) / 组织Issue核心开发者（含管理者）数量',
               example: 1,
               minimum: 0,
               nullable: true
             }
    ...
    class ParticipationTierOrgIssueCoreContributorsResponse < Grape::Entity
      ...
      expose :items, using: Entities::ParticipationTierOrgIssueCoreContributorsItem,
             documentation: { type: 'ParticipationTierOrgIssueCoreContributorsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
