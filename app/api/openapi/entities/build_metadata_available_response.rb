...
module Openapi
  module Entities
    class BuildMetadataAvailableItem < Grape::Entity
      ...
      expose :build_metadata_available,
             documentation: {
               type: 'Boolean',
               desc: 'Whether build input metadata is available / 构建元数据是否可获取',
               example: nil,
               nullable: true
             }
      ...
      expose :detail,
             documentation: {
               ...
               example: 'no metadata checker data'
             }
    end

    class BuildMetadataAvailableResponse < Grape::Entity
      ...
      expose :items, using: Entities::BuildMetadataAvailableItem,
             documentation: { type: 'Entities::BuildMetadataAvailableItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
