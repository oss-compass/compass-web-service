...
module Openapi
  module Entities
    ...
    class PrMergeRateItem < Grape::Entity
      ...
      expose :pr_merge_ratio, documentation: { type: 'Float', desc: 'pr_merge_ratio', example: 0.5 }
      expose :pr_merged_count, documentation: { type: 'int', desc: 'pr_merged_count', example: 10 }
