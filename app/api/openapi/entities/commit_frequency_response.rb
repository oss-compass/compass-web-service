...
module Openapi
  module Entities
    class CommitFrequencyMetricDetail < Grape::Entity
      expose :commit_frequency, documentation: { type: 'Float', desc: 'commit_frequency', example: 7.7042801556420235 }
      expose :commit_frequency_bot, documentation: { type: 'Float', desc: 'commit_frequency_bot', example: 0.4669260700389105 } # 注意类型从 Integer 改为 Float
      expose :commit_frequency_without_bot,
             documentation: { type: 'Float', desc: 'commit_frequency_without_bot', example: 7.237354085603113 }
    end
    ...
    class CommitFrequencyItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'metric_name', example: 'commit_frequency' }
      expose :metric_detail, using: Entities::CommitFrequencyMetricDetail,
                             documentation: { type: 'CommitFrequencyMetricDetail', desc: 'metric_detail' }
    ...
    class CommitFrequencyResponse < Grape::Entity
      ...
      expose :items, using: Entities::CommitFrequencyItem,
                     documentation: { type: 'Entities::CommitFrequencyItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
