...
module Openapi
  module Entities
    ...
    class PrHandleTimeResponseItem < Grape::Entity
      ...
      expose :pr_new_handle_time_avg, documentation: { type: 'Float', desc: 'pr_new_handle_time_avg', example: 0.5 }
      expose :pr_new_handle_time_mid, documentation: { type: 'Float', desc: 'pr_new_handle_time_mid', example: 0.5 }
    end

    class PrHandleTimeResponse < Grape::Entity
      ...
      expose :items, using: Entities::PrHandleTimeResponseItem,
             documentation: { type: 'Entities::PrHandleTimeResponseItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
