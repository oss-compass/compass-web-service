...
module Openapi
  module Entities
    ...
    class OrgCommitFrequencyItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: '指标名称', example: "组织提交频率统计" }
