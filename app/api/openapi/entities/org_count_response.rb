...
module Openapi
  module Entities
    ...
    class OrgCountItem < Grape::Entity
      ...
      expose :metric_detail, using: Entities::OrgCountMetricDetail,
                             documentation: { type: 'OrgCountMetricDetail', desc: 'metric_detail' }
    ...
    class OrgCountResponse < Grape::Entity
      ...
      expose :items, using: Entities::OrgCountItem,
                     documentation: { type: 'Entities::OrgCountItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
...
#       expose :items, using: Entities::OrgCountItem, documentation: { type: 'Entities::OrgCountItem', desc: 'response',
