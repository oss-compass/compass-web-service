...
module Openapi
  module Entities
    class CoreRetentionIndividualCodeCoreRetentionItem < Grape::Entity
      expose :uuid, documentation: { type: 'String', desc: 'uuid' }
      expose :level, documentation: { type: 'String', desc: 'level', example: 'repo' }
      expose :label, documentation: { type: 'String', desc: 'label' }
      expose :individual_code_core_retention,
             documentation: {
               type: 'Float',
               desc: 'Individual code core retention (ratio) / 个人代码核心开发者（含管理者）留存率',
    ...
    class CoreRetentionIndividualCodeCoreRetentionResponse < Grape::Entity
      ...
      expose :items, using: Entities::CoreRetentionIndividualCodeCoreRetentionItem,
             documentation: { type: 'CoreRetentionIndividualCodeCoreRetentionItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
