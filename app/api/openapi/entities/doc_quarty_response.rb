...
module Openapi
  module Entities
    ...
    class DocQuartyMetricPicture < Grape::Entity
      expose :code_blocks, documentation: { type: 'int', desc: 'Code Block Count / 代码块数量', example: '' }
      expose :images, documentation: { type: 'int', desc: 'Image Count / 图像数量', example: '' }
      expose :videos, documentation: { type: 'int', desc: 'Video Count / 视频数量', example: '' }
      expose :audios, documentation: { type: 'int', desc: 'Audio Count / 音频数量', example: '' }
      expose :external_links, documentation: { type: 'int', desc: 'External Links Status / 外部链接情况', example: '' }
    end
    ...
    class DocQuartyItem < Grape::Entity
      ...
      expose :metric_detail, using: Entities::DocQuartyMetricDetail, documentation: { type: 'Entities::DocQuartyMetricDetail', desc: 'Metric Details / 指标详情', param_type: 'body'}
