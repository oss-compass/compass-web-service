...
module Openapi
  module Entities
    class IndividualNonCodeContributionItem < Grape::Entity
      ...
      expose :individual_non_code_contribution,
             documentation: {
               type: 'Integer',
               desc: '个人非代码贡献量（贡献次数）/ Individual non-code contribution (count)',
               example: 130,
               minimum: 0,
               nullable: true
             }
    ...
    class IndividualNonCodeContributionResponse < Grape::Entity
      ...
      expose :items, using: Entities::IndividualNonCodeContributionItem,
             documentation: { type: 'IndividualNonCodeContributionItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
