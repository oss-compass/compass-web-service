...
module Openapi
  module Entities
    ...
    class LinesAddOfCodeFrequencyItem < Grape::Entity
      ...
      expose :metric_name,
             documentation: { type: 'String', desc: 'metric_name', example: 'lines_add_of_code_frequency' }
      expose :metric_detail, using: Entities::LinesAddOfCodeFrequencyMetricDetail,
                             documentation: { type: 'LinesAddOfCodeFrequencyMetricDetail', desc: 'metric_detail' }
