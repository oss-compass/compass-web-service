  ...
  module Entities
    ...
    class OrgContributionMetricDetail < Grape::Entity
      expose :org_contribution, documentation: {
        type: 'Float',
        desc: 'Organization Contribution Score (0-1), representing the proportion of contributions from organizations in the project. Higher values indicate higher organizational contribution and more organization-led projects/组织贡献度评分（0-1之间），表示项目中来自组织的贡献占比。数值越高表示组织贡献度越高，项目越倾向于组织主导。',
        example: 0.75
      }
      expose :org_contribution_details, using: Entities::OrgContributionRepoDetail, documentation: {
        ...
        desc: 'Organization Contribution Details List for Each Repository/各仓库的组织贡献详情列表',
        is_array: true
      }
    end
    ...
    class OrgContributionItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'Metric Name/指标名称', example: "Evaluating organizational and institutional contributions to open source software." }
