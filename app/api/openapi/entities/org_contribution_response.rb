...
module Openapi
  module Entities
    class OrgContributionMetricDetail < Grape::Entity
      expose :org_contribution,
             documentation: {
               type: 'Float',
               desc: '组织综合贡献度指数（0-100区间）',
               example: 0.0,
               minimum: 0.0,
               maximum: 100.0,
               required: true
      ...
      expose :org_contribution_details,
             documentation: {
               type: 'Array[Hash]',
               desc: '多维度贡献明细',
               example: [{ dimension: '代码提交', score: [] }],
               is_array: true,
               required: true
             }
    end
    ...
    class OrgContributionItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'metric_name', example: 'org_contribution' }
      expose :metric_detail, using: Entities::OrgContributionMetricDetail,
                             documentation: { type: 'OrgContributionMetricDetail', desc: 'metric_detail' }
    ...
    class OrgContributionResponse < Grape::Entity
      ...
      expose :items, using: Entities::OrgContributionItem,
                     documentation: { type: 'Entities::OrgContributionItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
...
#       expose :items, using: Entities::OrgContributionItem, documentation: { type: 'Entities::OrgContributionItem', desc: 'response',
