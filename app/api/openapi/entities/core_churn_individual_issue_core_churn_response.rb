...
module Openapi
  module Entities
    class CoreChurnIndividualIssueCoreChurnItem < Grape::Entity
      expose :uuid, documentation: { type: 'String', desc: 'uuid' }
      expose :level, documentation: { type: 'String', desc: 'level', example: 'repo' }
      expose :label, documentation: { type: 'String', desc: 'label' }
      expose :individual_issue_core_churn,
             documentation: {
               type: 'Float',
               desc: 'Individual Issue core churn (ratio) / 个人Issue核心开发者（含管理者）淡出率',
               example: 0,
               nullable: true
             }
    ...
    class CoreChurnIndividualIssueCoreChurnResponse < Grape::Entity
      ...
      expose :items, using: Entities::CoreChurnIndividualIssueCoreChurnItem,
             documentation: { type: 'CoreChurnIndividualIssueCoreChurnItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
