...
module Openapi
  module Entities
    ...
    class ParticipationTierOrgIssueRegularContributorsResponse < Grape::Entity
      ...
      expose :items, using: Entities::ParticipationTierOrgIssueRegularContributorsItem,
             documentation: { type: 'ParticipationTierOrgIssueRegularContributorsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
