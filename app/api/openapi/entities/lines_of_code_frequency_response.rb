...
module Openapi
  module Entities
    class LinesOfCodeFrequencyMetricDetail < Grape::Entity
      expose :lines_of_code_frequency,
             documentation: {
               type: 'Float',
               desc: 'Code Lines Change Frequency (times/week) / 代码行变更频率（单位：次/周）',
               example: 15.5,
               minimum: 0.0,
               format: 'float',
               nullable: true
    ...
    class LinesOfCodeFrequencyItem < Grape::Entity
      ...
      expose :metric_name,
             documentation: { type: 'String', desc: 'Metric Name / 指标名称', example: 'lines_of_code_frequency' }
      expose :metric_detail, using: Entities::LinesOfCodeFrequencyMetricDetail,
             documentation: { type: 'LinesOfCodeFrequencyMetricDetail', desc: 'Metric Details / 指标详情' }
    ...
    class LinesOfCodeFrequencyResponse < Grape::Entity
      ...
      expose :items, using: Entities::LinesOfCodeFrequencyItem,
             documentation: { type: 'Entities::LinesOfCodeFrequencyItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
...
#       expose :items, using: Entities::LinesOfCodeFrequencyItem, documentation: { type: 'Entities::LinesOfCodeFrequencyItem', desc: 'response',
