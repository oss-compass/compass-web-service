...
module Openapi
  module Entities
    ...
    class OrgContributionLastItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'metric_name', example: 'org_contribution_last' }
      expose :metric_detail, using: Entities::OrgContributionLastMetricDetail,
                             documentation: { type: 'OrgContributionLastMetricDetail', desc: 'metric_detail' }
    ...
    class OrgContributionLastResponse < Grape::Entity
      ...
      expose :items, using: Entities::OrgContributionLastItem,
                     documentation: { type: 'Entities::OrgContributionLastItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
...
#       expose :items, using: Entities::OrgContributionLastItem, documentation: { type: 'Entities::OrgContributionLastItem', desc: 'response',
