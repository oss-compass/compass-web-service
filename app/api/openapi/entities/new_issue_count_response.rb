...
module Openapi
  module Entities
    ...
    class NewIssueCountItem < Grape::Entity
      ...
      expose :new_issue_count,
             documentation: {
               type: 'Integer',
               desc: 'New Issue Count (Issues created in cycle) / 新增Issue数（周期内创建的Issue总数）',
               example: 45,
               minimum: 0,
               nullable: true
             }
    ...
    class NewIssueCountResponse < Grape::Entity
      ...
      expose :items, using: Entities::NewIssueCountItem,
             documentation: { type: 'NewIssueCountItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
