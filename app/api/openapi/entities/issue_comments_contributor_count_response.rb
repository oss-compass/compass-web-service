...
module Openapi
  module Entities
    ...
    class IssueCommentsContributorCountItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: '指标名称', example: "Issue评论者数量统计" }
