...
module Openapi
  module Entities
    ...
    class ZhFilesNumberMetricDetail < Grape::Entity
      expose :zh_files_number, documentation: { type: 'int', desc: '仓库中文文档支持度', example: 1 }
    end
    ...
    class ZhFilesNumberItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: '指标名称', example: "仓库中文文档支持度" }
      expose :metric_detail, using: Entities::ZhFilesNumberMetricDetail, documentation: { type: 'Entities::ZhFilesNumberMetricDetail', desc: '指标详情', param_type: 'body'}
