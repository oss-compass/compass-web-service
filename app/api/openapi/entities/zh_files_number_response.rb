...
module Openapi
  module Entities
    ...
    class ZhFilesNumberMetricDetail < Grape::Entity
      expose :zh_files_number, documentation: { type: 'int', desc: 'Chinese Documentation Support Level/仓库中文文档支持度', example: 1 }
    end


    class ZhFilesNumberItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'Metric Name/指标名称', example: "Chinese Documentation Support Level" }
      expose :metric_detail, using: Entities::ZhFilesNumberMetricDetail, documentation: { type: 'Entities::ZhFilesNumberMetricDetail', desc: 'Metric Details/指标详情', param_type: 'body'}
    ...
    class ZhFilesNumberResponse < Grape::Entity
      ...
      expose :items, using: Entities::ZhFilesNumberItem, documentation: { type: 'Entities::ZhFilesNumberItem', desc: 'response',
