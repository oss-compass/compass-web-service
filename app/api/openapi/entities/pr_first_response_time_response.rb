...
module Openapi
  module Entities
    ...
    class PrFirstResponseTimeResponseItem < Grape::Entity
      ...
      expose :pr_new_first_response_avg, documentation: { type: 'Float', desc: 'pr_new_first_response_avg', example: 0.5 }
      expose :pr_new_first_response_mid, documentation: { type: 'Float', desc: 'pr_new_first_response_mid', example: 0.5 }
    end

    class PrFirstResponseTimeResponse < Grape::Entity
      ...
      expose :items, using: Entities::PrFirstResponseTimeResponseItem,
             documentation: { type: 'Entities::PrFirstResponseTimeResponseItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
