...
module Openapi
  module Entities
    class GovernanceOrgsItem < Grape::Entity
      ...
      expose :governance_orgs_count,
             documentation: {
               type: 'Integer',
               desc: '参与治理的组织个数（不含社区发起组织）/ Governance orgs count',
               example: 3,
               minimum: 0,
               nullable: true
             }
    ...
    class GovernanceOrgsResponse < Grape::Entity
      ...
      expose :items, using: Entities::GovernanceOrgsItem,
             documentation: { type: 'GovernanceOrgsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
