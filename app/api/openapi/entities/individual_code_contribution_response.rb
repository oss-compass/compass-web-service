...
module Openapi
  module Entities
    class IndividualCodeContributionItem < Grape::Entity
      ...
      expose :individual_code_contribution,
             documentation: {
               type: 'Integer',
               desc: '个人代码贡献量（代码行数）/ Individual code contribution (lines)',
               example: 3000,
               minimum: 0,
               nullable: true
             }
    ...
    class IndividualCodeContributionResponse < Grape::Entity
      ...
      expose :items, using: Entities::IndividualCodeContributionItem,
             documentation: { type: 'IndividualCodeContributionItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
