...
module Openapi
  module Entities
    class IndividualManagersItem < Grape::Entity
      ...
      expose :individual_managers_count,
             documentation: {
               type: 'Integer',
               desc: '个人管理者数量 / Individual managers count',
               example: 3,
               minimum: 0,
               nullable: true
             }
    ...
    class IndividualManagersResponse < Grape::Entity
      ...
      expose :items, using: Entities::IndividualManagersItem,
             documentation: { type: 'IndividualManagersItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
