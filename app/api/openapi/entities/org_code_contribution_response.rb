...
module Openapi
  module Entities
    class OrgCodeContributionResponseItem < Grape::Entity
      ...
      expose :org_code_contribution,
             documentation: {
               type: 'int',
               desc: '组织代码贡献量 / Org code contribution',
               example: 100
             }
    ...
    class OrgCodeContributionResponse < Grape::Entity
      ...
      expose :items, using: Entities::OrgCodeContributionResponseItem,
             documentation: { type: 'OrgCodeContributionResponseItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
