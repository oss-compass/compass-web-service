...
module Openapi
  module Entities
    class CoreLossIndividualCodeCoreLossItem < Grape::Entity
      expose :uuid, documentation: { type: 'String', desc: 'uuid' }
      expose :level, documentation: { type: 'String', desc: 'level', example: 'repo' }
      expose :label, documentation: { type: 'String', desc: 'label' }
      expose :individual_code_core_loss,
             documentation: {
               type: 'Float',
               desc: 'Individual code core loss (ratio) / 个人代码核心开发者（含管理者）流失率',
               example: 0,
               nullable: true
             }
    ...
    class CoreLossIndividualCodeCoreLossResponse < Grape::Entity
      ...
      expose :items, using: Entities::CoreLossIndividualCodeCoreLossItem,
             documentation: { type: 'CoreLossIndividualCodeCoreLossItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
