...
module Openapi
  module Entities
    ...
    class DeveloperPromotionOrgCodeCorePromotionCountResponse < Grape::Entity
      ...
      expose :items, using: Entities::DeveloperPromotionOrgCodeCorePromotionCountItem,
             documentation: { type: 'DeveloperPromotionOrgCodeCorePromotionCountItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
