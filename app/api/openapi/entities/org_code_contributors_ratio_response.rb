...
module Openapi
  module Entities
    class OrgCodeContributorsRatioItem < Grape::Entity
      ...
      expose :org_code_contributors_ratio,
             documentation: {
               type: 'Float',
               desc: '组织代码贡献者数量占总代码贡献者数量比例 / Org code contributors ratio',
               example: 0.65,
               minimum: 0.0,
               maximum: 1.0,
               nullable: true
    ...
    class OrgCodeContributorsRatioResponse < Grape::Entity
      ...
      expose :items, using: Entities::OrgCodeContributorsRatioItem,
             documentation: { type: 'OrgCodeContributorsRatioItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
