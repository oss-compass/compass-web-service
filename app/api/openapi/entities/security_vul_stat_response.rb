...
module Openapi
  module Entities
    ...
    class SecurityVulStatMetricDetail < Grape::Entity
      expose :security_vul_stat, documentation: { type: 'int', desc: '安全漏洞数', example: 10 }
    end
    ...
    class SecurityVulStatItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: '指标名称', example: "安全漏洞数" }
      expose :metric_detail, using: Entities::SecurityVulStatMetricDetail, documentation: { type: 'Entities::SecurityVulStatMetricDetail', desc: '指标详情', param_type: 'body'}
