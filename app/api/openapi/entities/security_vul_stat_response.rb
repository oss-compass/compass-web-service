...
module Openapi
  module Entities
    ...
    class SecurityVulStatMetricDetail < Grape::Entity
      expose :security_vul_stat, documentation: { type: 'int', desc: 'Number of Security Vulnerabilities / 安全漏洞数', example: 10 }
    end


    class SecurityVulStatItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'Metric Name / 指标名称', example: "Number of Security Vulnerabilities" }
      expose :metric_detail, using: Entities::SecurityVulStatMetricDetail, documentation: { type: 'Entities::SecurityVulStatMetricDetail', desc: 'Metric Details / 指标详情', param_type: 'body'}
    ...
    class SecurityVulStatResponse < Grape::Entity
      ...
      expose :items, using: Entities::SecurityVulStatItem, documentation: { type: 'Entities::SecurityVulStatItem', desc: 'response',
