...
module Openapi
  module Entities
    class CoreLossIndividualIssueCoreLossItem < Grape::Entity
      expose :uuid, documentation: { type: 'String', desc: 'uuid' }
      expose :level, documentation: { type: 'String', desc: 'level', example: 'repo' }
      expose :label, documentation: { type: 'String', desc: 'label' }
      expose :individual_issue_core_loss,
             documentation: {
               type: 'Float',
               desc: 'Individual Issue core loss (ratio) / 个人Issue核心开发者（含管理者）流失率',
               example: 0,
               nullable: true
             }
    ...
    class CoreLossIndividualIssueCoreLossResponse < Grape::Entity
      ...
      expose :items, using: Entities::CoreLossIndividualIssueCoreLossItem,
             documentation: { type: 'CoreLossIndividualIssueCoreLossItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
