...
module Openapi
  module Entities
    ...
    class IssueCommentCountItem < Grape::Entity
      ...
      expose :issue_comment_count,
             documentation: {
               type: 'Integer',
               desc: 'Issue Comment Count (Comments under Issues in cycle) / Issue讨论活跃度（周期内Issue下评论总数）',
               example: 280,
               minimum: 0,
               nullable: true
             }
    ...
    class IssueCommentCountResponse < Grape::Entity
      ...
      expose :items, using: Entities::IssueCommentCountItem,
             documentation: { type: 'IssueCommentCountItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
