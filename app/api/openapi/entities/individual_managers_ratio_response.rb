...
module Openapi
  module Entities
    class IndividualManagersRatioItem < Grape::Entity
      ...
      expose :individual_managers_ratio,
             documentation: {
               type: 'Float',
               desc: '个人管理者数量占总管理者数比例 / Individual managers ratio',
               example: 0.40,
               minimum: 0.0,
               maximum: 1.0,
               nullable: true
    ...
    class IndividualManagersRatioResponse < Grape::Entity
      ...
      expose :items, using: Entities::IndividualManagersRatioItem,
             documentation: { type: 'IndividualManagersRatioItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
