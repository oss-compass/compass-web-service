...
module Openapi
  module Entities
    ...
    class StarsItem < Grape::Entity
      ...
      expose :stars_added, documentation: { type: 'int', desc: 'stars_added', example: 0.5 }
      expose :stars_total, documentation: { type: 'int', desc: 'stars_total', example: 0.5 }
    end

    class StarsResponse < Grape::Entity
      ...
      expose :items, using: Entities::StarsItem,
             documentation: { type: 'Entities::StarsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
