...
module Openapi
  module Entities
    class CoreLossOrgCodeCoreLossItem < Grape::Entity
      expose :uuid, documentation: { type: 'String', desc: 'uuid' }
      expose :level, documentation: { type: 'String', desc: 'level', example: 'repo' }
      expose :label, documentation: { type: 'String', desc: 'label' }
      expose :org_code_core_loss,
             documentation: {
               type: 'Float',
               desc: 'Org code core loss (ratio) / 组织代码核心开发者（含管理者）流失率',
               example: 0,
               nullable: true
             }
    ...
    class CoreLossOrgCodeCoreLossResponse < Grape::Entity
      ...
      expose :items, using: Entities::CoreLossOrgCodeCoreLossItem,
             documentation: { type: 'CoreLossOrgCodeCoreLossItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
