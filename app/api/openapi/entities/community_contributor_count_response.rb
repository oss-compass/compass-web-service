...
module Openapi
  module Entities
    ...
    class CommunityContributorCountItem < Grape::Entity
      ...
      expose :contributor_count,
             documentation: {
               type: 'Integer',
               desc: 'Community Contributor Count (Total Active Contributors) / 社区贡献者数量（总活跃贡献者数）',
               example: 42,
               minimum: 0,
               nullable: true
             }
    ...
    class CommunityContributorCountResponse < Grape::Entity
      ...
      expose :items, using: Entities::CommunityContributorCountItem,
             documentation: { type: 'CommunityContributorCountItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
