...
module Openapi
  module Entities
    class DeveloperAttractionNewIndividualNonCodeContributorsItem < Grape::Entity
      ...
      expose :new_individual_non_code_contributors,
             documentation: {
               type: 'Integer',
    ...
    class DeveloperAttractionNewIndividualNonCodeContributorsResponse < Grape::Entity
      ...
      expose :items, using: Entities::DeveloperAttractionNewIndividualNonCodeContributorsItem,
             documentation: { type: 'DeveloperAttractionNewIndividualNonCodeContributorsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
