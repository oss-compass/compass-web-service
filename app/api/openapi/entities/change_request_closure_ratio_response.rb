  ...
  module Entities
    class ChangeRequestClosureRatioMetricDetail < Grape::Entity
      expose :change_request_closure_ratio,
             documentation: {
               type: 'Float',
               desc: 'PR Closure Rate (Closed PRs/Total PRs) / PR关闭率（已关闭PR数/总PR数）',
               example: 0.7500,
    ...
    class ChangeRequestClosureRatioItem < Grape::Entity
      ...
      expose :metric_name,
             documentation: { type: 'String', desc: 'Metric Name / 指标名称', example: 'change_request_closure_ratio' }
      expose :metric_detail, using: Entities::ChangeRequestClosureRatioMetricDetail,
             documentation: { type: 'ChangeRequestClosureRatioMetricDetail', desc: 'Metric Details / 指标详情' }
    ...
    class ChangeRequestClosureRatioResponse < Grape::Entity
      ...
      expose :items, using: Entities::ChangeRequestClosureRatioItem,
             documentation: { type: 'Entities::ChangeRequestClosureRatioItem', desc: 'Response Items / 响应项', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
