...
module Openapi
  module Entities
    class DeveloperAttractionNewOrgCodeContributorsItem < Grape::Entity
      ...
      expose :new_org_code_contributors,
             documentation: {
               type: 'Integer',
    ...
    class DeveloperAttractionNewOrgCodeContributorsResponse < Grape::Entity
      ...
      expose :items, using: Entities::DeveloperAttractionNewOrgCodeContributorsItem,
             documentation: { type: 'DeveloperAttractionNewOrgCodeContributorsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
