...
module Openapi
  module Entities
    class CoreChurnIndividualCodeCoreChurnItem < Grape::Entity
      expose :uuid, documentation: { type: 'String', desc: 'uuid' }
      expose :level, documentation: { type: 'String', desc: 'level', example: 'repo' }
      expose :label, documentation: { type: 'String', desc: 'label' }
      expose :individual_code_core_churn,
             documentation: {
               type: 'Float',
               desc: 'Individual code core churn (ratio) / 个人代码核心开发者（含管理者）淡出率',
               example: 0.5,
               nullable: true
             }
    ...
    class CoreChurnIndividualCodeCoreChurnResponse < Grape::Entity
      ...
      expose :items, using: Entities::CoreChurnIndividualCodeCoreChurnItem,
             documentation: { type: 'CoreChurnIndividualCodeCoreChurnItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
