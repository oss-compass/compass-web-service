  ...
  module Entities
    class CodeReviewCountMetricDetail < Grape::Entity
      expose :code_review_count,
             documentation: {
               type: 'Float',
               desc: 'Code Review Count (Normalized Value)/代码审查计数（标准化值）',
               example: 3.1415,
    ...
    class CodeReviewCountItem < Grape::Entity
      ...
      expose :metric_detail, using: Entities::CodeReviewCountMetricDetail,
             documentation: { type: 'CodeReviewCountMetricDetail', desc: 'Metric Details/指标详情' }
    ...
    class CodeReviewCountResponse < Grape::Entity
      ...
      expose :items, using: Entities::CodeReviewCountItem,
             documentation: { type: 'Entities::CodeReviewCountItem', desc: 'Response Items/响应项', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
