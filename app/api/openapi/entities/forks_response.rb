...
module Openapi
  module Entities
    ...
    class ForksItem < Grape::Entity
      ...
      expose :forks_added, documentation: { type: 'int', desc: 'forks_added', example: 0.5 }
      expose :forks_total, documentation: { type: 'int', desc: 'forks_total', example: 0.5 }
    end

    class ForksResponse < Grape::Entity
      ...
      expose :items, using: Entities::ForksItem,
             documentation: { type: 'Entities::ForksItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
