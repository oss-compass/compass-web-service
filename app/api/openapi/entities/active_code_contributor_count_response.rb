...
module Openapi
  module Entities
    ...
    class ActiveCodeContributorCountItem < Grape::Entity
      ...
      expose :code_contributor_count,
             documentation: {
               type: 'Integer',
               desc: 'Active Code Contributor Count / 活跃代码贡献者数量',
               example: 28,
               minimum: 0,
               nullable: true
             }
    ...
    class ActiveCodeContributorCountResponse < Grape::Entity
      ...
      expose :items, using: Entities::ActiveCodeContributorCountItem,
             documentation: { type: 'ActiveCodeContributorCountItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
