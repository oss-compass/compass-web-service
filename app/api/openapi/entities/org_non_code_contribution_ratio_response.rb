...
module Openapi
  module Entities
    class OrgNonCodeContributionRatioItem < Grape::Entity
      ...
      expose :org_non_code_contribution_ratio,
             documentation: {
               type: 'Float',
               desc: '组织非代码贡献量占非代码总贡献量比例 / Org non-code contribution ratio',
               example: 0.55,
               minimum: 0.0,
               maximum: 1.0,
               nullable: true
    ...
    class OrgNonCodeContributionRatioResponse < Grape::Entity
      ...
      expose :items, using: Entities::OrgNonCodeContributionRatioItem,
             documentation: { type: 'OrgNonCodeContributionRatioItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
