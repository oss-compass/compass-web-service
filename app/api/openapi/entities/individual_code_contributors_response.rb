...
module Openapi
  module Entities
    class IndividualCodeContributorsItem < Grape::Entity
      ...
      expose :individual_code_contributors_count,
             documentation: {
               type: 'Integer',
               desc: '个人代码贡献者数量 / Individual code contributors count',
               example: 15,
               minimum: 0,
               nullable: true
             }
    ...
    class IndividualCodeContributorsResponse < Grape::Entity
      ...
      expose :items, using: Entities::IndividualCodeContributorsItem,
             documentation: { type: 'IndividualCodeContributorsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
