...
module Openapi
  module Entities
    ...
    class DocNumberMetricDetail < Grape::Entity
      expose :doc_number, documentation: { type: 'int', desc: '文档数量', example: 50 }
    ...
    class DocNumberItem < Grape::Entity
      ...
      expose :metric_detail, using: Entities::DocNumberMetricDetail, documentation: { type: 'Entities::DocNumberMetricDetail', desc: '指标详情', param_type: 'body'}
