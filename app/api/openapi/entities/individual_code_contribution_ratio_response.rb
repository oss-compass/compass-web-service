...
module Openapi
  module Entities
    class IndividualCodeContributionRatioItem < Grape::Entity
      ...
      expose :individual_code_contribution_ratio,
             documentation: {
               type: 'Float',
               desc: '个人代码贡献量占代码总贡献量比例 / Individual code contribution ratio',
               example: 0.28,
               minimum: 0.0,
               maximum: 1.0,
               nullable: true
    ...
    class IndividualCodeContributionRatioResponse < Grape::Entity
      ...
      expose :items, using: Entities::IndividualCodeContributionRatioItem,
             documentation: { type: 'IndividualCodeContributionRatioItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
