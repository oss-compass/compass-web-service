...
module Openapi
  module Entities
    ...
    class IssueOpenTimeItem < Grape::Entity
      ...
      expose :issue_new_handle_time_avg, documentation: { type: 'Float', desc: 'issue_new_handle_time_avg', example: 0.5 }
      expose :issue_new_handle_time_mid, documentation: { type: 'Float', desc: 'issue_new_handle_time_mid', example: 0.5 }
