...
module Openapi
  module Entities
    class IndividualNonCodeContributorsRatioItem < Grape::Entity
      ...
      expose :individual_non_code_contributors_ratio,
             documentation: {
               type: 'Float',
               desc: '个人非代码贡献者数量占总非代码贡献者数量比例 / Individual non-code contributors ratio',
               example: 0.55,
               minimum: 0.0,
               maximum: 1.0,
               nullable: true
    ...
    class IndividualNonCodeContributorsRatioResponse < Grape::Entity
      ...
      expose :items, using: Entities::IndividualNonCodeContributorsRatioItem,
             documentation: { type: 'IndividualNonCodeContributorsRatioItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
