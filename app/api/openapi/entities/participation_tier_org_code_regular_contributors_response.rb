...
module Openapi
  module Entities
    ...
    class ParticipationTierOrgCodeRegularContributorsResponse < Grape::Entity
      ...
      expose :items, using: Entities::ParticipationTierOrgCodeRegularContributorsItem,
             documentation: { type: 'ParticipationTierOrgCodeRegularContributorsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
