...
module Openapi
  module Entities
    ...
    class CodeReviewRatioItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'metric_name', example: 'code_review_ratio' }
      expose :metric_detail, using: Entities::CodeReviewRatioMetricDetail,
                             documentation: { type: 'CodeReviewRatioMetricDetail', desc: 'metric_detail' }
    ...
    class CodeReviewRatioResponse < Grape::Entity
      ...
      expose :items, using: Entities::CodeReviewRatioItem,
                     documentation: { type: 'Entities::CodeReviewRatioItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
