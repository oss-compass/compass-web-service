...
module Openapi
  module Entities
    class DeveloperPromotionIndividualIssueCorePromotionCountItem < Grape::Entity
      expose :uuid, documentation: { type: 'String', desc: 'uuid' }
      expose :level, documentation: { type: 'String', desc: 'level', example: 'repo' }
      expose :label, documentation: { type: 'String', desc: 'label' }
      expose :individual_issue_core_promotion_count,
             documentation: {
               type: 'Integer',
    ...
    class DeveloperPromotionIndividualIssueCorePromotionCountResponse < Grape::Entity
      ...
      expose :items, using: Entities::DeveloperPromotionIndividualIssueCorePromotionCountItem,
             documentation: { type: 'DeveloperPromotionIndividualIssueCorePromotionCountItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
