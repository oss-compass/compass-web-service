...
module Openapi
  module Entities
    class OrgManagersItem < Grape::Entity
      ...
      expose :org_managers_count,
             documentation: {
               type: 'Integer',
               desc: '组织管理者数量（不含社区发起组织）/ Org managers count',
               example: 4,
               minimum: 0,
               nullable: true
             }
    ...
    class OrgManagersResponse < Grape::Entity
      ...
      expose :items, using: Entities::OrgManagersItem,
             documentation: { type: 'OrgManagersItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
