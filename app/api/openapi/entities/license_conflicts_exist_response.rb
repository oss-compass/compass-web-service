...
module Openapi
  module Entities
    ...
    class LicenseConflictsExistMetricDetail < Grape::Entity
      expose :license_conflicts_exist, documentation: { type: 'int', desc: '仓库开源许可证兼容性', example: 1 }
    end
    ...
    class LicenseConflictsExistItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: '指标名称', example: "仓库开源许可证兼容性" }
      expose :metric_detail, using: Entities::LicenseConflictsExistMetricDetail, documentation: { type: 'Entities::LicenseConflictsExistMetricDetail', desc: '指标详情', param_type: 'body'}
