...
module Openapi
  module Entities
    class CoreRetentionOrgIssueCoreRetentionItem < Grape::Entity
      expose :uuid, documentation: { type: 'String', desc: 'uuid' }
      expose :level, documentation: { type: 'String', desc: 'level', example: 'repo' }
      expose :label, documentation: { type: 'String', desc: 'label' }
      expose :org_issue_core_retention,
             documentation: {
               type: 'Float',
               desc: 'Org Issue core retention (ratio) / 组织Issue核心开发者（含管理者）留存率',
               example: 0.5,
               nullable: true
             }
    ...
    class CoreRetentionOrgIssueCoreRetentionResponse < Grape::Entity
      ...
      expose :items, using: Entities::CoreRetentionOrgIssueCoreRetentionItem,
             documentation: { type: 'CoreRetentionOrgIssueCoreRetentionItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
