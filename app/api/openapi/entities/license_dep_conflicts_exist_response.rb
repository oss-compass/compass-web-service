...
module Openapi
  module Entities
    ...
    class LicenseDepConflictsExistMetricDetail < Grape::Entity
      expose :license_dep_conflicts_exist, documentation: { type: 'int', desc: '开源软件和依赖软件是否兼容', example: 1 }
    end
    ...
    class LicenseDepConflictsExistItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: '指标名称', example: "开源软件和依赖软件是否兼容" }
      expose :metric_detail, using: Entities::LicenseDepConflictsExistMetricDetail, documentation: { type: 'Entities::LicenseDepConflictsExistMetricDetail', desc: '指标详情', param_type: 'body'}
