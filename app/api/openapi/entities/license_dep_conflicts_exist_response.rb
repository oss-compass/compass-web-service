...
module Openapi
  module Entities
    ...
    class LicenseDepConflictsExistMetricDetail < Grape::Entity
      expose :license_dep_conflicts_exist, documentation: { type: 'int', desc: 'Open Source and Dependency Software Compatibility / 开源软件和依赖软件是否兼容', example: 1 }
    end


    class LicenseDepConflictsExistItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'Metric Name / 指标名称', example: "Open Source and Dependency Software Compatibility" }
      expose :metric_detail, using: Entities::LicenseDepConflictsExistMetricDetail, documentation: { type: 'Entities::LicenseDepConflictsExistMetricDetail', desc: 'Metric Details / 指标详情', param_type: 'body'}
    ...
    class LicenseDepConflictsExistResponse < Grape::Entity
      ...
      expose :items, using: Entities::LicenseDepConflictsExistItem, documentation: { type: 'Entities::LicenseDepConflictsExistItem', desc: 'response',
