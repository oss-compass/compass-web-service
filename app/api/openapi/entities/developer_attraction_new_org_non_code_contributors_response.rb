...
module Openapi
  module Entities
    class DeveloperAttractionNewOrgNonCodeContributorsItem < Grape::Entity
      ...
      expose :new_org_non_code_contributors,
             documentation: {
               type: 'Integer',
    ...
    class DeveloperAttractionNewOrgNonCodeContributorsResponse < Grape::Entity
      ...
      expose :items, using: Entities::DeveloperAttractionNewOrgNonCodeContributorsItem,
             documentation: { type: 'DeveloperAttractionNewOrgNonCodeContributorsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
