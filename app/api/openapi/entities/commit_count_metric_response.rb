...
module Openapi
  module Entities
    ...
    class CommitCountMetricItem < Grape::Entity
    ...
    class CommitCountMetricResponse < Grape::Entity
      ...
      expose :items, using: Entities::CommitCountMetricItem,
             documentation: { type: 'Entities::CommitCountMetricItem', desc: 'response', param_type: 'body', is_array: true }
    end
