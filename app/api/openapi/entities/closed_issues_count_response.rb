  ...
  module Entities
    class ClosedIssuesCountMetricDetail < Grape::Entity
      expose :closed_issues_count,
             documentation: {
               type: 'Integer',
               desc: 'Total Closed Issues / 已关闭问题总数',
               example: 15,
               minimum: 0,
               required: true
             }
    ...
    class ClosedIssuesCountItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'Metric Name / 指标名称', example: 'closed_issues_count' }
      expose :metric_detail, using: Entities::ClosedIssuesCountMetricDetail,
             documentation: { type: 'ClosedIssuesCountMetricDetail', desc: 'Metric Details / 指标详情' }
    ...
    class ClosedIssuesCountResponse < Grape::Entity
      ...
      expose :items, using: Entities::ClosedIssuesCountItem,
             documentation: { type: 'Entities::ClosedIssuesCountItem', desc: 'Response Items / 响应项', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
