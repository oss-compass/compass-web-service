...
module Openapi
  module Entities
    class OrgNonCodeContributionItem < Grape::Entity
      ...
      expose :org_non_code_contribution,
             documentation: {
               type: 'Integer',
               desc: '组织非代码贡献量（贡献次数）/ Org non-code contribution (count)',
               example: 120,
               minimum: 0,
               nullable: true
             }
    ...
    class OrgNonCodeContributionResponse < Grape::Entity
      ...
      expose :items, using: Entities::OrgNonCodeContributionItem,
             documentation: { type: 'OrgNonCodeContributionItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
