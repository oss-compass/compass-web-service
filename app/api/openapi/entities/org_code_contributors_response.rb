...
module Openapi
  module Entities
    class OrgCodeContributorsItem < Grape::Entity
      ...
      expose :org_code_contributors_count,
             documentation: {
               type: 'Integer',
               desc: '组织代码贡献者数量 / Org code contributors count',
               example: 10,
               minimum: 0,
               nullable: true
             }
    ...
    class OrgCodeContributorsResponse < Grape::Entity
      ...
      expose :items, using: Entities::OrgCodeContributorsItem,
             documentation: { type: 'OrgCodeContributorsItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
