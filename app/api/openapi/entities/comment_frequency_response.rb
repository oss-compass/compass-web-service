...
module Openapi
  module Entities
    ...
    class CommentFrequencyItem < Grape::Entity
      ...
      expose :metric_name, documentation: { type: 'String', desc: 'metric_name', example: 'comment_frequency' }
      expose :metric_detail, using: Entities::CommentFrequencyMetricDetail,
                             documentation: { type: 'CommentFrequencyMetricDetail', desc: 'metric_detail' }
    ...
    class CommentFrequencyResponse < Grape::Entity
      ...
      expose :items, using: Entities::CommentFrequencyItem,
                     documentation: { type: 'Entities::CommentFrequencyItem', desc: 'response', param_type: 'body', is_array: true }
    end
  end
end
# module Openapi
