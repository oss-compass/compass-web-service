  ...
  module V2
    ...
    class ModelMilestonePersona < Grape::API
      ...
      resource :metricModel do
        desc 'List Project Contributor Milestone Persona / 获取项目贡献者里程画像', detail: 'List Project Contributor Milestone Persona / 获取项目贡献者里程画像', tags: ['V2 API', 'Metrics Model Data / 模型数据'], success: {
