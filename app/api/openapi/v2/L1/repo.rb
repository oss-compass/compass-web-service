  ...
  module V2
    module L1
      ...
      resource :metadata do
        desc 'List project repo metadata / 获取项目repo元数据', detail: 'List project repo metadata / 获取项目repo元数据', tags: ['V2 API','Metadata / 元数据'], success: {
        ...
        post :repos do
          ...
          indexer, repo_urls = select_idx_repos_by_lablel_and_level(label, level, GiteeRepoEnrich, GithubRepoEnrich, GitcodeRepoEnrich)
