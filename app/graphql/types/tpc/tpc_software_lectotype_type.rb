...
module Types
  module Tpc
    class TpcSoftwareLectotypeType < Types::BaseObject
      field :id, Integer, null: false
      # field :lectotype_type, Integer, description: 'incubation: 0, sandbox: 1, graduation: 2'
      field :tpc_software_lectotype_report_ids, [String]
      field :tpc_software_lectotype_reports, [Types::Tpc::TpcSoftwareLectotypeReportType]
      ...
      def tpc_software_lectotype_report_ids
        object.tpc_software_lectotype_report_ids.present? ? JSON.parse(object.tpc_software_lectotype_report_ids) : []
      end
      ...
      def tpc_software_lectotype_reports
        TpcSoftwareLectotypeReport.where(id: tpc_software_lectotype_report_ids)
      end
      ...
      def risk_count
        TpcSoftwareLectotype.get_risk_metric_list(object.target_software_report_id).length
      end
      ...
      def clarified_count
        TpcSoftwareLectotype.get_clarified_metric_list(object.target_software_report_id).length
      end
      ...
      def confirmed_count
        TpcSoftwareLectotype.get_confirmed_metric_list(object.target_software_report_id).length
      end
      ...
      def get_member_count(member_type)
        TpcSoftwareLectotype.get_comment_state_list(object.id).where(member_type: member_type).count
      end
