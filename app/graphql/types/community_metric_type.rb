...
module Types
  class CommunityMetricType < Types::BaseObject
    ...
    field :issue_first_reponsee_avg, Float, description: 'mean of issues first response time (days)'
    field :issue_first_reponsee_mid, Float, description: 'middle of issues first response time (days)'
