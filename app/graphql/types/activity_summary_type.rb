...
module Types
  class ActivitySummaryType < Types::BaseObject
    field :activity_score, MetricStatType, description: 'score of activity metric model'
    field :closed_issues_count, MetricStatType, description: 'number of issues closed in the past 90 days'
    ...
    field :active_c1_issue_create_contributor_count, MetricStatType, description: 'number of active C1 issue create contributors in the past 90 days'
    field :active_c1_issue_comments_contributor_count, MetricStatType, description: 'number of active C1 issue comments contributors in the past 90 days'
    ...
    field :created_since, MetricStatType, description: 'number of months since the project was created'
    field :updated_issues_count, MetricStatType, description: 'number of issue updates in the past 90 days'
    field :recent_releases_count, MetricStatType, description: 'number of releases in the last 90 days'
    field :updated_since, MetricStatType, description: '(average of months from the last code commit to the time of statistics'
