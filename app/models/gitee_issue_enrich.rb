  ...
  def self.mapping
    {"dynamic_templates"=>
     ...
     {"assignee_data_bot"=>{"type"=>"boolean"},
      ...
      "cve_base_score"=>{"type"=>"keyword"},
      "cve_create_time"=>{"type"=>"date"},
      "cve_handling_time"=>{"type"=>"float"},
      "cve_level"=>{"type"=>"keyword"},
      "cve_percerving_time"=>{"type"=>"float"},
      "cve_public_time"=>{"type"=>"keyword"},
      "gitee_repo"=>{"type"=>"keyword"},
      "grimoire_creation_date"=>{"type"=>"date"},
      "id"=>{"type"=>"long"},
      "id_in_repo"=>{"type"=>"keyword"},
      "is_gitee_issue"=>{"type"=>"long"},
