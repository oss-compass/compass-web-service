# == Schema Information
#
# Table name: tpc_software_lectotype_report_metric_raws
#
#  id                                      :bigint           not null, primary key
#  tpc_software_lectotype_report_metric_id :integer          not null
...
#
class TpcSoftwareLectotypeReportMetricRaw < ApplicationRecord
  belongs_to :tpc_software_lectotype_report_metric
  belongs_to :subject
end
