class CreateTpcSoftwareSandboxReportMetrics < ActiveRecord::Migration[7.1]
  def change
    create_table :tpc_software_sandbox_report_metrics do |t|
      ...
      # t.string :upstream_collaboration_strategy_detail, limit: 255
